...
namespace Assistant
{
	...
	/// </summary>
	public static class LibraryKalendar
	{
		#region Method public
		public static bool IsFranceWorkingDay(DateTime dtDate)
		{
			...
			bolWorkingDay = ! ((dtDate.DayOfWeek == DayOfWeek.Sunday) || (dtDate.DayOfWeek == DayOfWeek.Saturday) || (Array.BinarySearch(arrDateFerie,dtDate) >= 0));
			if (bolWorkingDay )
			{
				...
				// lundi de pâques
				DateTime dtMondayPaques;
				if (intDayPaques+1 > 31) dtMondayPaques = new DateTime(dtDate.Year,intMonthPaques+1,(intDayPaques+1-31));
				else dtMondayPaques = new DateTime(dtDate.Year,intMonthPaques,intDayPaques+1);
				// Ascension
